  ...
  <div class="dashboard">
      ...
      <div class="d-flex flex-column containerAsideMenu ps-4" style="margin-top: 80px;">
        <div class="mb-5">
          <span style="font-size: 20px;font-weight: 800; color: var(--primary-color) !important;">
            Dashboard <i class="bi bi-info-circle"></i>
          </span>
          <div>
            17/10/2025 - 10:20
          </div>
        </div>
        <router-link to="/dashboard" class="activeRouter">Dashboard</router-link>
        <div>
        ...
        <router-link to="/magazzino" class="mt-3">Notifiche</router-link>
        <router-link to="/officina">Agenda</router-link>
        <router-link to="/officina">Promemoria</router-link>
      </div>
    ...
    <main class="content">
      <div class="d-flex align-items-center justify-content-between pb-4">
        ...
        style="background-color: #fff;border-radius: 100px;padding-left: 20px;">
          <i class="bi bi-search"></i>
          <input type="text" style="width: 400px;border: 0;padding: 10px 10px;" placeholder="Cerca qualcosa usando parole chiave...">
        </div>
        <div>
...
.containerAsideMenu *:not(.containerAsideMenu *:last-child) {
  margin-bottom: 10px;
}

.containerAsideMenu *.activeRouter {
