...
const rowData = ref([
    { codice: 'NS001', rimborso: '150 €', dipendente: 'Mario Rossi', tipologia: 'Viaggio', fornitore: 'Trenitalia', 'data-spesa': '2024-05-10', 'mese-rimborso': '--', status: 0 },
    { codice: 'NS002', rimborso: '80 €', dipendente: 'Luigi Bianchi', tipologia: 'Pasti', fornitore: 'Autogrill', 'data-spesa': '2024-05-12', 'mese-rimborso': '--', status: 0 },
    { codice: 'NS003', rimborso: '200 €', dipendente: 'Giulia Verdi', tipologia: 'Alloggio', fornitore: 'Hotel Roma', 'data-spesa': '2024-05-15', 'mese-rimborso': '--', status: 0 },
    { codice: 'NS004', rimborso: '50 €', dipendente: 'Francesca Neri', tipologia: 'Materiale', fornitore: 'Cartoleria XYZ', 'data-spesa': '2024-05-18', 'mese-rimborso': '--', status: 0 },
    { codice: 'NS005', rimborso: '120 €', dipendente: 'Alessandro Russo', tipologia: 'Viaggio', fornitore: 'Italo Treno', 'data-spesa': '2024-05-20', 'mese-rimborso': '--', status: 0 },
...
<template>
    <div>
        <div class="d-flex align-items-center justify-content-between mt-5">
            <div>
                <b>Lista Note Spese in attesa di gestione</b>
                <div class="miniText">
                    Gestisci le spese dei tuoi dipendenti.
                </div>
            </div>
